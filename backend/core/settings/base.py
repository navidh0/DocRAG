...
REFRESH_COOKIE_SECURE: bool = not DEBUG
REFRESH_COOKIE_SAMESITE: str = env("REFRESH_COOKIE_SAMESITE", default="Lax")
REFRESH_COOKIE_MAX_AGE: int = int(
    timedelta(days=env.int("REFRESH_TOKEN_LIFETIME_DAYS", default=7)).total_seconds()
)
...
RERANK_TOP_K = env.int("RERANK_TOP_K", default=5)
...
LOGGING = {
    ...
    "loggers": {
        ...
        "qa": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}